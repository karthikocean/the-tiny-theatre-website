  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex space-x-8 text-lg font-body">
        ...
        <a href="#why" className="hover:text-[#FFC512] transition-colors">Why Choose Us</a>
        <a href="#screens" className="hover:text-[#FFC512] transition-colors">Private Screens</a>
        <a href="#booking" className="hover:text-[#FFC512] transition-colors">Booking Process</a>
      ...
      {isOpen && (
        <motion.div
          ...
          exit={{ height: 0 }}
        >
          <a href="#hero" className="text-lg hover:text-[#FFC512]" onClick={toggleMenu}>Home</a>
          <a href="#why" className="text-lg hover:text-[#FFC512]" onClick={toggleMenu}>Why Choose Us</a>
          <a href="#screens" className="text-lg hover=text-[#FFC512]" onClick={toggleMenu}>Private Screens</a>
          <a href="#booking" className="text-lg hover:text-[#FFC512]" onClick={toggleMenu}>Booking Process</a>
          <a href="#gallery" className="text-lg hover:text-[#FFC512]" onClick={toggleMenu}>Gallery</a>
        </motion.div>
      )}
